                                ...
                                (item.subItems ? (
                                    <li className="nav-item">
                                        ...
                                        >
                                            ...
                                            <span data-key="t-apps"> <span className='text'> {props.t(item.label)}</span></span>
                                        </Link>
                                        <Collapse
                                                        ...
                                                        {!subItem.isChildItem ? (
                                                            <li className="nav-item">
                                                                ...
                                                                >
                                                                    ...
                                                                    <span className='text'>  {props.t(subItem.label)}</span>
                                                                </Link>
                                                            </li>
                                                        ) : (
                                                            <li className="nav-item">
                                                                                    ...
                                                                                    {!childItem.childItems ?
                                                                                        <li className="nav-item">
                                                                                            <Link
                                                                                                ...
                                                                                                <span className='text'> {props.t(childItem.label)}</span>
                                                                                            </Link>
                                                                                        </li>
                                                                                        : <li className="nav-item">
                                                                                            <Link
                                                                                                // to='/#'
                                                                                                to={subItem.link}
                                                                                                className="nav-link" onClick={childItem.click} data-bs-toggle="collapse">
                                                                                                <i className={childItem.icon}></i>
                                                                                                <span className='text'> {props.t(childItem.label)}</span>
                                                                                            </Link>
                                                                                                    ...
                                                                                                    {childItem.childItems.map((subChildItem, key) => (
                                                                                                        <li className="nav-item" key={key}>
                                                                                                            <Link
                                                                                                                ...
                                                                                                                className="nav-link" data-key="t-basic-action"> <span className='text'> {props.t(subChildItem.label)} </span></Link>
                                                                                                        </li>
                                                                                                    ))}
                                                                                                </ul>
                                                                                            </Collapse>
                                    ...
                                    <li className="nav-item">
                                        ...
                                        >
                                            <i className={item.icon}></i>  <span className='text'> {props.t(item.label)}</span>
                                        </Link>
                                    </li>
                                ))
                            )
