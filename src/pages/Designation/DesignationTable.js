...
const DesignationTable = ({ DesignationDataArr, EditDesignationToggle, toggleArchive, Loading, permissions }) => {
                ...
                (permissions?.edit || permissions?.delete) ?
                    <ButtonGroup>
                        <UncontrolledButtonDropdown>
                            {permissions?.edit ?
                                <Button color="primary" className='d-flex align-items-center' onClick={() => EditDesignationToggle(data, dataArr)}>
                                    <i className="ri-pencil-fill me-1 align-bottom"></i>{t('edit')}
                                </Button>
                                :
                                <></>
                            }
                            {permissions?.delete ? <><DropdownToggle tag="button" className="btn btn-primary" split>
                            </DropdownToggle>
                                <DropdownMenu >
                                    {data.status === 2 ?
